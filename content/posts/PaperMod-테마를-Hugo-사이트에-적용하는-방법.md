...
<a href="https://git-scm.com/downloads" target="_blank">Git 설치링크</a> <br/>
...
<a href="https://go.dev/doc/install" target="_blank">Go 설치링크</a> <br/>
...
<a href="https://gohugo.io/installation/" target="_blank">Hugo 설치링크</a>

아 참고로, Hugo 설치는 명령어를 통해 진행합니다.   
설치할 때 헷갈리시면 아래 링크에서 방법을 확인해주세요.

<a href="https://www.devkuma.com/docs/hugo/overview/" target="_blank">Hugo 설치방법 링크</a>
